...
import { ChevronDown, ChevronRight, Plane, Radio, AlertTriangle, Navigation, Radar, Search, Edit2, Save, X, Plus, Trash2, FileText } from 'lucide-react';
...
const AirspaceInfoApp = () => {
  ...
  const startEditAirspace = (airspace) => {
    setEditingAirspace(JSON.parse(JSON.stringify(airspace))); // Deep copy
    setEditMode(true);
  };
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-2xl max-w-md w-full p-6">
              ...
              <p className="text-gray-600 mb-2">
                Are you sure you want to delete the airspace:
              </p>
...
export default AirspaceInfoApp;
